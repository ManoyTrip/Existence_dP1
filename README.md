...
NB: The code was executed in Magma v28-25. Using different versions of Magma may result in differing output (notably, a difference in the ordering of the conjugacy classes of W(E7) and W(E8)).
